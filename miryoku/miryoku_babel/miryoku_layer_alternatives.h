...
#define MIRYOKU_ALTERNATIVES_BASE_POSITIONAL_COLEMAKDH \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
...
U_LT_L(U_BUTTON, Z), U_MT_L(RALT, X), &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT_R(RALT, DOT), U_LT_R(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT_L(U_MEDIA, ESC),U_LT_L(U_NAV, SPACE),U_LT_L(U_MOUSE, TAB),U_LT_R(U_SYM, RET),U_LT_R(U_NUM, BSPC),U_LT_R(U_FUN, DEL),U_NP,              U_NP
