...
#if !defined(MIRYOKU_LAYER_MODS)
  #define MIRYOKU_LAYER_MODS MIRYOKU_ALTERNATIVES_MODS
#endif
#if !defined(MIRYOKU_LAYERMAPPING_MODS)
  #define MIRYOKU_LAYERMAPPING_MODS MIRYOKU_MAPPING
#endif
